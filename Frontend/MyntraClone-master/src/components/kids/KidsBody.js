...
// function KidsBody(props) {
//     return (
//         <div className='col'>
//             <img className='col-12 mt-4'onClick={() => { props.history.push('/filterkids') }}
...
function WomenBody(props) {
  return (
    <div className='col text-center'>
    <img className='col-10 mt-4'onClick={() => { props.history.push('/filterkids') }}
      src='https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2021/12/7/bc993d6c-2cf7-4c5d-b20c-d8cddff8caee1638869622654-Cutecumber_Desk_Banner.jpg'
    ...
    <div className='col-12 p-2'>
      {imgWomenArr.map(val => {
        ...
        onClick={() => { props.history.push('/filterkids') }}
